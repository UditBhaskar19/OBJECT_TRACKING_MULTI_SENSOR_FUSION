...
run('Scripts_Global_Variables_and_Sim_Data/SensorFusion_Script2_RESTRUCTURE_LINE_SIMULATION_DATA.m');
run('Scripts_Global_Variables_and_Sim_Data/SensorFusion_Script3_LOAD_DATA_STRUCTURE_PARAMETERS.m');
run('Scripts_Global_Variables_and_Sim_Data/SensorFusion_Script3_LOAD_LINE_DATA_STRUCTURE_PARAMETERS.m');
...
% =======================================>  SET OBJECT TRACKING MODEL PARAMETERS% <=============================================================================
sigmaQ = 1;
...
% =======================================>  SET LINE TRACKING MODEL PARAMETERS% <===============================================================================
MEAS_MODEL_LINE = LANE_ESTIMATION.ClothoidCoeffMeasModel(0.5, 0.05, 0.005, 0.0005);   % set the observation model
sigmaSq_y0 = 1; sigmaSq_A0 = 0.5; sigmaSq_K0 = 0.05; sigmaSq_Khat = 0.005;
...
for t = 1:nTimeSample
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %PLOTS.VisualizeTrackData_Radar(TRACK_ESTIMATES_RAD, RADAR_MEAS_CTS, nRadars, GammaSq);
    %PLOTS.VisualizeTrackData_Camera(TRACK_ESTIMATES_CAM, CAMERA_MEAS_CTS, nCameras, GammaSq);
    ...
    % ======================================================> LANE COMPUTATION <================================================================================
    CAMERA_CAN_LANE_LINE_BUS = SENSOR_INTERFACE_LANE.CAM_SENSOR_INTERFACE(CAM1_Line_Sensor_Simulated_Data, CAM1_Line_Sensor_Simulated_Data, ...
                                                                          CAMERA_CAN_LANE_LINE_BUS, t, nLineCameras, nLineMeas);
    LANE_LINE_MEAS_MAT = SENSOR_INTERFACE_LANE.CREATE_LANE_LINE_MEAS_MAT(nLineCameras, nLineMeas, CAMERA_CAN_LANE_LINE_BUS, LANE_LINE_MEAS_MAT);
    
    LANE_TRACK_BOUNDARY = LANE_ESTIMATION.LANE_LINE_STRUCTURE(LANE_TRACK_BOUNDARY,LANE_LINE_MEAS_MAT, MEAS_MODEL_LINE);
    
    [Width, RoadWidth] = LANE_ESTIMATION.ComputeLaneWidth(LANE_TRACK_BOUNDARY);
    LaneWidth = Width;
    %LaneWidth = 3.95;
    
    EGO_LANE_CENTER_TRACK_HYPOTHESIS = LANE_ESTIMATION.EGO_LANE_HYPOTHESIS(EGO_LANE_CENTER_TRACK_HYPOTHESIS, LANE_TRACK_BOUNDARY, LaneWidth/2);
    
    ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION = LANE_ESTIMATION.EGO_LANE_PREDICTION(ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, EGO_CAN_BUS, ...
                                                                                 sigmaSq_y0, sigmaSq_A0, sigmaSq_K0, sigmaSq_Khat, dT);
                                                                             
    EGO_LANE_CENTER_TRACK_HYPOTHESIS = LANE_ESTIMATION.EGO_LANE_UPDATE(EGO_LANE_CENTER_TRACK_HYPOTHESIS, ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, MEAS_MODEL_LINE);
    
    ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION = LANE_ESTIMATION.EGO_LANE_TRACK_TO_TRACK_FUSION_v2(ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, ...
                                                                                               EGO_LANE_CENTER_TRACK_HYPOTHESIS);
    % LANE BOUNDARIES COMPUTATION
    ROAD_PROFILE.EGO_LANE_NEXT_NEXT_RIGHT_BOUNDARY = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_NEXT_NEXT_RIGHT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, 2*LaneWidth + LaneWidth/2);
    ROAD_PROFILE.EGO_LANE_NEXT_RIGHT_BOUNDARY      = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_NEXT_RIGHT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, 1*LaneWidth + LaneWidth/2);
    ROAD_PROFILE.EGO_LANE_RIGHT_BOUNDARY           = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_RIGHT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, LaneWidth/2);                                                  
    ROAD_PROFILE.EGO_LANE_LEFT_BOUNDARY            = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_LEFT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, -LaneWidth/2);
    ROAD_PROFILE.EGO_LANE_NEXT_LEFT_BOUNDARY       = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_NEXT_LEFT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, -(1*LaneWidth + LaneWidth/2));
    ROAD_PROFILE.EGO_LANE_NEXT_NEXT_LEFT_BOUNDARY  = LANE_ESTIMATION.LANE_GEOMETRY(ROAD_PROFILE.EGO_LANE_NEXT_NEXT_LEFT_BOUNDARY, ...
                                                                            ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, -(2*LaneWidth + LaneWidth/2));  
    
    % ROAD PROFILE COMPUTATION
    ROAD_GEOMETRY.EgoLaneCenter              = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneCenter, ...
                                                                        ROAD_PROFILE.EGO_LANE_CENTER_TRACK_ESTIMATION, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneRightBoundary       = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneRightBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_RIGHT_BOUNDARY, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneNxtRightBoundary    = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneNxtRightBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_NEXT_RIGHT_BOUNDARY, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneNxtNxtRightBoundary = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneNxtNxtRightBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_NEXT_NEXT_RIGHT_BOUNDARY, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneLeftBoundary        = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneLeftBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_LEFT_BOUNDARY, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneNxtLeftBoundary     = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneNxtLeftBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_NEXT_LEFT_BOUNDARY, EGO_CAN_BUS, dT);
    ROAD_GEOMETRY.EgoLaneNxtNxtLeftBoundary  = LANE_ESTIMATION.LANE_LINE_MODEL(ROAD_GEOMETRY.EgoLaneNxtNxtLeftBoundary, ...
                                                                        ROAD_PROFILE.EGO_LANE_NEXT_NEXT_LEFT_BOUNDARY, EGO_CAN_BUS, dT);
    ...
    XLimit = [-150 120]; YLimit = [-40 40]; markerA = '-';markerB = '-';
    VISUALIZE.VisualizeTrackData_AND_Lane(FUSED_TRACKS, TRACK_ESTIMATES_FUS, TRACK_ESTIMATES_RAD, TRACK_ESTIMATES_CAM, ...
                             RADAR_MEAS_CLUSTER, RADAR_MEAS_CTS, CAMERA_MEAS_CTS,  nNewTracks, nRadars, nCameras, GammaSq, TRAJECTORY_HISTORY, ...
